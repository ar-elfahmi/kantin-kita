...
<body>
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-footer">
                <div class="sidebar-user">
                    <img class="user-avatar" src="https://api.builder.io/api/v1/image/assets/TEMP/087ab2dd772577a5a55f3825b36f4260590b6776?width=80" alt="Warung Mbok Sri">
                    <div style="flex:1;min-width:0;">
                        <div class="user-name">Warung Mbok Sri</div>
                        <div class="user-email">vendor@kantinkita.id</div>
                    </div>
            ...
            <header class="page-header">
                ...
                <div class="header-right">
                    ...
                    <div class="header-user-chip">
                        <img class="header-avatar" src="https://api.builder.io/api/v1/image/assets/TEMP/d2809f4985ab877fe9cc63eb8ac265662cce04ff?width=64" alt="Warung Mbok Sri">
                        <span class="header-username">Warung Mbok Sri</span>
                    </div>
                </div>
            </header>
                    ...
                    <div class="products-grid">
                        ...
                        <div class="product-card">
                            <div class="product-image-wrap">
                                <img class="product-img" src="https://api.builder.io/api/v1/image/assets/TEMP/ba6382dc578b32751a4c6e03f2066fc64f93e8ce?width=504" alt="Nasi Goreng Spesial">
                                <span class="product-badge green-badge">Best Seller</span>
                            </div>
                            <div class="product-info">
                                <div class="product-name">Nasi Goreng Spesial</div>
                                <div class="product-desc">Nasi goreng dengan telur mata sapi, ayam, dan bumbu rahasia khas warung.</div>
                        ...
                        <div class="product-card">
                            <div class="product-image-wrap">
                                <img class="product-img" src="https://api.builder.io/api/v1/image/assets/TEMP/3c5c09db60a4a2b7edf59cf09759e90f728ef682?width=504" alt="Bakso Kuah Spesial">
                                <span class="product-badge brown-badge">Populer</span>
                            </div>
                            <div class="product-info">
                                <div class="product-name">Bakso Kuah Spesial</div>
                                <div class="product-desc">Bakso sapi dengan mie, sayuran segar dan kuah kaldu yang gurih.</div>
                                <div class="product-meta">
                        ...
                        <div class="product-card">
                            <div class="product-image-wrap">
                                <img class="product-img" src="https://api.builder.io/api/v1/image/assets/TEMP/b7bc82529c259c8ada923ec2170e09044304699d?width=504" alt="Soto Ayam Lamongan">
                            </div>
                            <div class="product-info">
                                <div class="product-name">Soto Ayam Lamongan</div>
                                <div class="product-desc">Soto ayam kuning dengan telur, soun, dan sayuran segar berkuah bening.</div>
                                <div class="product-meta">
                        ...
                        <div class="product-card">
                            <div class="product-image-wrap">
                                <img class="product-img" src="https://api.builder.io/api/v1/image/assets/TEMP/51abe326054c31ac42ba035e0234a59fd2ae076e?width=504" alt="Es Teh Manis">
                            </div>
                            <div class="product-info">
                                <div class="product-name">Es Teh Manis</div>
                                <div class="product-desc">Teh manis dingin dengan es batu, kesegaran sempurna di hari yang panas.</div>
                                <div class="product-meta">
                ...
                <div class="bottom-grid reveal">
                    ...
                    <div class="orders-panel">
                        ...
                        <div class="orders-list">
                            ...
                            <div class="order-row">
                                <img class="order-thumb" src="https://api.builder.io/api/v1/image/assets/TEMP/ba6382dc578b32751a4c6e03f2066fc64f93e8ce?width=128" alt="Nasi Goreng Spesial">
                                <div class="order-info">
                                    <div class="order-name">Nasi Goreng Spesial</div>
                                    <div class="order-qty">2x &bull; Rp 36.000</div>
                                </div>
                                <div class="order-right">
                                    <span class="status-badge status-pending">Pending</span>
                                    <span class="order-time">5 menit lalu</span>
                                </div>
                            </div>

                            <div class="order-row">
                                <img class="order-thumb" src="https://api.builder.io/api/v1/image/assets/TEMP/3c5c09db60a4a2b7edf59cf09759e90f728ef682?width=128" alt="Bakso Kuah Spesial">
                                <div class="order-info">
                                    <div class="order-name">Bakso Kuah Spesial</div>
                                    <div class="order-qty">1x &bull; Rp 15.000</div>
                                </div>
                                <div class="order-right">
                                    <span class="status-badge status-process">Diproses</span>
                                    <span class="order-time">12 menit lalu</span>
                                </div>
                            </div>

                            <div class="order-row">
                                <img class="order-thumb" src="https://api.builder.io/api/v1/image/assets/TEMP/b7bc82529c259c8ada923ec2170e09044304699d?width=128" alt="Soto Ayam Lamongan">
                                <div class="order-info">
                                    <div class="order-name">Soto Ayam Lamongan</div>
                                    <div class="order-qty">3x &bull; Rp 36.000</div>
                                </div>
                                <div class="order-right">
                    ...
                    <div class="summary-panel">
                        ...
                        <div class="summary-row">
                            ...
                            <span class="summary-row-value">Rp 2.450.000</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-row-label">Minggu Ini</span>
                            <span class="summary-row-value">Rp 14.200.000</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-row-label">Bulan Ini</span>
                            <span class="summary-row-value">Rp 48.500.000</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-row-label">Target Bulan Ini</span>
                            <span class="summary-row-value">Rp 80.000.000</span>
                        </div>
                        <div class="summary-progress-block">
                            <div class="progress-pct" id="progressPct">60%</div>
    ...
    <script>
        ...
        /* Run counters after a brief delay */
        setTimeout(() => {
            ...
            statValues.forEach((el, i) => {
                if (targets[i] && i < 2) {
                    ...
                    animateCounter(el, targets[i].val, targets[i].prefix, targets[i].suffix, 1200);
                    setTimeout(() => {
                        el.textContent = orig;
                    }, 1250);
                }
