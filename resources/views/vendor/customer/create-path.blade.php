...
<head>
    ...
    <title>Tambah Customer 2 (File Path) | Kantin Kita</title>
    ...
    <style>
        ...
        *,*::before,*::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .info-strip { display: flex; align-items: flex-start; gap: 10px; padding: 12px 14px; background: rgba(116, 70, 34, .08); border-radius: 10px; color: var(--brown); font-size: 13px; margin-bottom: 20px; }
...
<div class="dashboard-shell">
    ...
    <div class="main-content">
        ...
        <header class="page-header">
            <div>
                <div class="header-title">Tambah Customer 2 (File Path)</div>
                <div class="header-subtitle">Foto disimpan ke disk, hanya path-nya yang masuk database</div>
            </div>
        ...
        <div class="dashboard-body">
            ...
            <section class="panel">
                ...
                <form method="POST" action="{{ route('dashboard.customer.store-path') }}" id="customerForm">
                    @csrf

                    <div class="panel-body">

                        <div class="info-strip">
                            <strong>Mode:</strong>&nbsp;Foto disimpan ke <code>storage/app/public/customers/{uuid}.png</code>; database hanya menyimpan path relatif di kolom <code>foto_path</code>.
                        </div>
