    ...
    <main>
        <div class="page-body">
            ...
            <div class="category-pills reveal reveal-delay-2">
                <button class="pill pill-active" onclick="setActive(this)">All Vendors</button>
                <button class="pill pill-inactive" onclick="setActive(this)">Indonesian</button>
                <button class="pill pill-inactive" onclick="setActive(this)">Western</button>
                <button class="pill pill-inactive" onclick="setActive(this)">Asian</button>
                <button class="pill pill-inactive" onclick="setActive(this)">Beverages</button>
                <button class="pill pill-inactive" onclick="setActive(this)">Snacks</button>
            </div>

            <!-- Vendors Grid -->
            <div class="vendors-grid">

                <!-- Card 1: Warung Nusantara -->
                <article class="vendor-card reveal reveal-delay-1">
                    <div class="card-image-wrap">
                        <img src="https://images.pexels.com/photos/3590401/pexels-photo-3590401.jpeg?auto=compress&cs=tinysrgb&w=864&h=512&fit=crop" alt="Warung Nusantara" class="card-food-img" />
                    ...
                    <div class="card-body">
                        <h3 class="vendor-name">Warung Nusantara</h3>
                        ...
                        <div class="vendor-tags">
                            <span class="vendor-tag">Indonesian</span>
                            <span class="vendor-tag">Halal</span>
                        </div>
                        <p class="vendor-desc">Authentic Indonesian cuisine with signature nasi goreng and traditional satay. Fresh ingredients daily.</p>
                        <div class="card-footer-row">
                            <div class="price-group">
                                <span class="price-label">Starting from</span>
                                <span class="price-value">Rp 15.000</span>
                            </div>
                            <a class="order-btn" href="{{ route('menu') }}">Order Now</a>
                        </div>
                    </div>
                </article>

                <!-- Card 2: The Burger Hub -->
                <article class="vendor-card reveal reveal-delay-2">
                    <div class="card-image-wrap">
                        <img src="https://api.builder.io/api/v1/image/assets/TEMP/8eae28831fbb7d76231e72013a84088be8fb3d13?width=864" alt="The Burger Hub" class="card-food-img" />
                        <div class="card-badges">
                            <span class="badge-label badge-rating">
                                <svg width="13" height="12" viewBox="0 0 14 12" fill="none">
                                    <path d="M7.4274 0.421875C7.30318 0.164062 7.04068 0 6.7524 0C6.46412 0 6.20396 0.164062 6.0774 0.421875L4.57037 3.52266L1.20474 4.01953C0.923491 4.06172 0.689116 4.25859 0.602397 4.52812C0.515678 4.79766 0.585991 5.09531 0.787553 5.29453L3.22974 7.71094L2.65318 11.1258C2.6063 11.407 2.72349 11.693 2.95552 11.8594C3.18755 12.0258 3.49458 12.0469 3.74771 11.9133L6.75474 10.3078L9.76177 11.9133C10.0149 12.0469 10.3219 12.0281 10.554 11.8594C10.786 11.6906 10.9032 11.407 10.8563 11.1258L10.2774 7.71094L12.7196 5.29453C12.9211 5.09531 12.9938 4.79766 12.9047 4.52812C12.8157 4.25859 12.5836 4.06172 12.3024 4.01953L8.93443 3.52266L7.4274 0.421875Z" fill="#EAB308" />
                    ...
                    <div class="card-body">
                        <h3 class="vendor-name">The Burger Hub</h3>
                        <div class="vendor-location">
                            <svg width="11" height="14" viewBox="0 0 11 14" fill="none">
                                <path d="M5.89805 13.65C7.30078 11.8945 10.5 7.63984 10.5 5.25C10.5 2.35156 8.14844 0 5.25 0C2.35156 0 0 2.35156 0 5.25C0 7.63984 3.19922 11.8945 4.60195 13.65C4.93828 14.0684 5.56172 14.0684 5.89805 13.65ZM5.25 3.5C5.71413 3.5 6.15925 3.68437 6.48744 4.01256C6.81563 4.34075 7 4.78587 7 5.25C7 5.71413 6.81563 6.15925 6.48744 6.48744C6.15925 6.81563 5.71413 7 5.25 7C4.78587 7 4.34075 6.81563 4.01256 6.48744C3.68437 6.15925 3.5 5.71413 3.5 5.25C3.5 4.78587 3.68437 4.34075 4.01256 4.01256C4.34075 3.68437 4.78587 3.5 5.25 3.5Z" fill="#42766A" />
                            </svg>
                        ...
                        <div class="vendor-tags">
                            <span class="vendor-tag">Western</span>
                            <span class="vendor-tag">Fast Food</span>
                        </div>
                        <p class="vendor-desc">Premium burgers made with quality beef patties, fresh vegetables, and homemade sauces.</p>
                        <div class="card-footer-row">
                            <div class="price-group">
                                <span class="price-label">Starting from</span>
                ...
                <!-- Card 3: Bubble Tea Corner -->
                <article class="vendor-card reveal reveal-delay-3">
                    <div class="card-image-wrap">
                        <img src="https://api.builder.io/api/v1/image/assets/TEMP/b5ba4c85139506ab2fd522e5e767ae7d0ecbce34?width=864" alt="Bubble Tea Corner" class="card-food-img" />
                        <div class="card-badges">
                            <span class="badge-label badge-green">New</span>
                            <span class="badge-label badge-rating">
                                <svg width="13" height="12" viewBox="0 0 14 12" fill="none">
                                    <path d="M7.4274 0.421875C7.30318 0.164062 7.04068 0 6.7524 0C6.46412 0 6.20396 0.164062 6.0774 0.421875L4.57037 3.52266L1.20474 4.01953C0.923491 4.06172 0.689116 4.25859 0.602397 4.52812C0.515678 4.79766 0.585991 5.09531 0.787553 5.29453L3.22974 7.71094L2.65318 11.1258C2.6063 11.407 2.72349 11.693 2.95552 11.8594C3.18755 12.0258 3.49458 12.0469 3.74771 11.9133L6.75474 10.3078L9.76177 11.9133C10.0149 12.0469 10.3219 12.0281 10.554 11.8594C10.786 11.6906 10.9032 11.407 10.8563 11.1258L10.2774 7.71094L12.7196 5.29453C12.9211 5.09531 12.9938 4.79766 12.9047 4.52812C12.8157 4.25859 12.5836 4.06172 12.3024 4.01953L8.93443 3.52266L7.4274 0.421875Z" fill="#EAB308" />
                                </svg>
                    ...
                    <div class="card-body">
                        <h3 class="vendor-name">Bubble Tea Corner</h3>
                        <div class="vendor-location">
                            <svg width="11" height="14" viewBox="0 0 11 14" fill="none">
                                <path d="M5.89805 13.65C7.30078 11.8945 10.5 7.63984 10.5 5.25C10.5 2.35156 8.14844 0 5.25 0C2.35156 0 0 2.35156 0 5.25C0 7.63984 3.19922 11.8945 4.60195 13.65C4.93828 14.0684 5.56172 14.0684 5.89805 13.65ZM5.25 3.5C5.71413 3.5 6.15925 3.68437 6.48744 4.01256C6.81563 4.34075 7 4.78587 7 5.25C7 5.71413 6.81563 6.15925 6.48744 6.48744C6.15925 6.81563 5.71413 7 5.25 7C4.78587 7 4.34075 6.81563 4.01256 6.48744C3.68437 6.15925 3.5 5.71413 3.5 5.25C3.5 4.78587 3.68437 4.34075 4.01256 4.01256C4.34075 3.68437 4.78587 3.5 5.25 3.5Z" fill="#42766A" />
                            </svg>
                        ...
                        <div class="vendor-tags">
                            <span class="vendor-tag">Beverages</span>
                            <span class="vendor-tag">Desserts</span>
                        </div>
                        <p class="vendor-desc">Fresh bubble tea with various flavors and toppings. Perfect for your study break!</p>
                        <div class="card-footer-row">
                            <div class="price-group">
                                <span class="price-label">Starting from</span>
                ...
                <!-- Card 4: Ramen Station -->
                <article class="vendor-card reveal reveal-delay-1">
                    <div class="card-image-wrap">
                        <img src="https://api.builder.io/api/v1/image/assets/TEMP/0c714eb1825d3dd142cfebe8527dc83ba75a69be?width=864" alt="Ramen Station" class="card-food-img" />
                        <div class="card-badges">
                            <span class="badge-label badge-rating">
                                <svg width="13" height="12" viewBox="0 0 14 12" fill="none">
                                    <path d="M7.4274 0.421875C7.30318 0.164062 7.04068 0 6.7524 0C6.46412 0 6.20396 0.164062 6.0774 0.421875L4.57037 3.52266L1.20474 4.01953C0.923491 4.06172 0.689116 4.25859 0.602397 4.52812C0.515678 4.79766 0.585991 5.09531 0.787553 5.29453L3.22974 7.71094L2.65318 11.1258C2.6063 11.407 2.72349 11.693 2.95552 11.8594C3.18755 12.0258 3.49458 12.0469 3.74771 11.9133L6.75474 10.3078L9.76177 11.9133C10.0149 12.0469 10.3219 12.0281 10.554 11.8594C10.786 11.6906 10.9032 11.407 10.8563 11.1258L10.2774 7.71094L12.7196 5.29453C12.9211 5.09531 12.9938 4.79766 12.9047 4.52812C12.8157 4.25859 12.5836 4.06172 12.3024 4.01953L8.93443 3.52266L7.4274 0.421875Z" fill="#EAB308" />
                    ...
                    <div class="card-body">
                        <h3 class="vendor-name">Ramen Station</h3>
                        <div class="vendor-location">
                            <svg width="11" height="14" viewBox="0 0 11 14" fill="none">
                                <path d="M5.89805 13.65C7.30078 11.8945 10.5 7.63984 10.5 5.25C10.5 2.35156 8.14844 0 5.25 0C2.35156 0 0 2.35156 0 5.25C0 7.63984 3.19922 11.8945 4.60195 13.65C4.93828 14.0684 5.56172 14.0684 5.89805 13.65ZM5.25 3.5C5.71413 3.5 6.15925 3.68437 6.48744 4.01256C6.81563 4.34075 7 4.78587 7 5.25C7 5.71413 6.81563 6.15925 6.48744 6.48744C6.15925 6.81563 5.71413 7 5.25 7C4.78587 7 4.34075 6.81563 4.01256 6.48744C3.68437 6.15925 3.5 5.71413 3.5 5.25C3.5 4.78587 3.68437 4.34075 4.01256 4.01256C4.34075 3.68437 4.78587 3.5 5.25 3.5Z" fill="#42766A" />
                            </svg>
                        ...
                        <div class="vendor-tags">
                            <span class="vendor-tag">Asian</span>
                            <span class="vendor-tag">Japanese</span>
                        </div>
                        <p class="vendor-desc">Authentic Japanese ramen with rich broth and fresh toppings. Comfort food at its finest.</p>
                        <div class="card-footer-row">
                            <div class="price-group">
                                <span class="price-label">Starting from</span>
                                <span class="price-value">Rp 28.000</span>
                            </div>
                            <button class="order-btn">Order Now</button>
                        </div>
                    </div>
                ...
                <!-- Card 5: Fresh & Healthy -->
                <article class="vendor-card reveal reveal-delay-2">
                    <div class="card-image-wrap">
                        <img src="https://api.builder.io/api/v1/image/assets/TEMP/ececcd477fc1231e4bbe74a931558732204a0e78?width=864" alt="Fresh & Healthy" class="card-food-img" />
                        <div class="card-badges">
                            <span class="badge-label badge-rating">
                                <svg width="13" height="12" viewBox="0 0 14 12" fill="none">
                                    <path d="M7.4274 0.421875C7.30318 0.164062 7.04068 0 6.7524 0C6.46412 0 6.20396 0.164062 6.0774 0.421875L4.57037 3.52266L1.20474 4.01953C0.923491 4.06172 0.689116 4.25859 0.602397 4.52812C0.515678 4.79766 0.585991 5.09531 0.787553 5.29453L3.22974 7.71094L2.65318 11.1258C2.6063 11.407 2.72349 11.693 2.95552 11.8594C3.18755 12.0258 3.49458 12.0469 3.74771 11.9133L6.75474 10.3078L9.76177 11.9133C10.0149 12.0469 10.3219 12.0281 10.554 11.8594C10.786 11.6906 10.9032 11.407 10.8563 11.1258L10.2774 7.71094L12.7196 5.29453C12.9211 5.09531 12.9938 4.79766 12.9047 4.52812C12.8157 4.25859 12.5836 4.06172 12.3024 4.01953L8.93443 3.52266L7.4274 0.421875Z" fill="#EAB308" />
                    ...
                    <div class="card-body">
                        <h3 class="vendor-name">Fresh &amp; Healthy</h3>
                        <div class="vendor-location">
                            <svg width="11" height="14" viewBox="0 0 11 14" fill="none">
                                <path d="M5.89805 13.65C7.30078 11.8945 10.5 7.63984 10.5 5.25C10.5 2.35156 8.14844 0 5.25 0C2.35156 0 0 2.35156 0 5.25C0 7.63984 3.19922 11.8945 4.60195 13.65C4.93828 14.0684 5.56172 14.0684 5.89805 13.65ZM5.25 3.5C5.71413 3.5 6.15925 3.68437 6.48744 4.01256C6.81563 4.34075 7 4.78587 7 5.25C7 5.71413 6.81563 6.15925 6.48744 6.48744C6.15925 6.81563 5.71413 7 5.25 7C4.78587 7 4.34075 6.81563 4.01256 6.48744C3.68437 6.15925 3.5 5.71413 3.5 5.25C3.5 4.78587 3.68437 4.34075 4.01256 4.01256C4.34075 3.68437 4.78587 3.5 5.25 3.5Z" fill="#42766A" />
                            </svg>
                        ...
                        <div class="vendor-tags">
                            <span class="vendor-tag">Healthy</span>
                            <span class="vendor-tag">Salads</span>
                        </div>
                        <p class="vendor-desc">Nutritious salad bowls and healthy meal options for health-conscious students.</p>
                        <div class="card-footer-row">
                            <div class="price-group">
                                <span class="price-label">Starting from</span>
                ...
                <article class="vendor-card reveal reveal-delay-3">
                    <div class="card-image-wrap">
                        <img src="https://api.builder.io/api/v1/image/assets/TEMP/ae917f5edf17a276a169dc78fb9e5a9a81fa6485?width=864" alt="Campus Brew" class="card-food-img" />
                        <div class="card-badges">
                            <span class="badge-label badge-green">Popular</span>
                            <span class="badge-label badge-rating">
                                <svg width="13" height="12" viewBox="0 0 14 12" fill="none">
                    ...
                    <div class="card-body">
                        <h3 class="vendor-name">Campus Brew</h3>
                        <div class="vendor-location">
                            <svg width="11" height="14" viewBox="0 0 11 14" fill="none">
                                <path d="M5.89805 13.65C7.30078 11.8945 10.5 7.63984 10.5 5.25C10.5 2.35156 8.14844 0 5.25 0C2.35156 0 0 2.35156 0 5.25C0 7.63984 3.19922 11.8945 4.60195 13.65C4.93828 14.0684 5.56172 14.0684 5.89805 13.65ZM5.25 3.5C5.71413 3.5 6.15925 3.68437 6.48744 4.01256C6.81563 4.34075 7 4.78587 7 5.25C7 5.71413 6.81563 6.15925 6.48744 6.48744C6.15925 6.81563 5.71413 7 5.25 7C4.78587 7 4.34075 6.81563 4.01256 6.48744C3.68437 6.15925 3.5 5.71413 3.5 5.25C3.5 4.78587 3.68437 4.34075 4.01256 4.01256C4.34075 3.68437 4.78587 3.5 5.25 3.5Z" fill="#42766A" />
                            </svg>
                        ...
                        <div class="vendor-tags">
                            <span class="vendor-tag">Coffee</span>
                            <span class="vendor-tag">Beverages</span>
                        </div>
                        <p class="vendor-desc">Premium coffee and specialty drinks. Perfect spot for your caffeine fix between classes.</p>
                        <div class="card-footer-row">
                            <div class="price-group">
                                <span class="price-label">Starting from</span>
